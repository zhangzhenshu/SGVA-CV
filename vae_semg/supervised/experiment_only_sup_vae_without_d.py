...
from paper_experiments.vae_semg.supervised.model_vae_without_d import VAE
...
if __name__ == "__main__":
    ...
    parser.add_argument('--aux_loss_multiplier_d', type=float, default=0.,
    ...
    if work_method == 'train':
        for seed in range(5):
            ...
            for i in range(8):
                ...
                print(args.outpath)
                model_name = "../saved_model/vae/" + 'test_domain_' + str(args.list_test_domain[0]) + '_vae20_seed_' + str(
                    args.seed)
    ...
    if work_method == 'test':
        ...
        for seed in range(10):
            ...
            for i in range(8):
                ...
                # Model name
                args.list_test_domain = [args.list_test_domain]
                model_name = '../saved_model/vae/' + 'test_domain_' + str(args.list_test_domain[0]) + '_vae_seed_' + str(
                    args.seed)
                # print("Test_Subject:", model_name)
