...
from paper_experiments.vae_semg.supervised.model_vae import VAE
from paper_experiments.vae_semg_.dataset.semgdata_loader import semgdata_load
    ...
    if work_method == 'train':
        for seed in range(10):
            ...
            for i in range(8):
                ...
                print(args.outpath)
                model_name = "../saved_model/vae/" + 'test_domain_' + str(
                    args.list_test_domain[0]) + '_vae_seed_' + str(
                    args.seed)
...
# 9[
#     0.6841982886904762, 0.8378452034883721, 0.7841342659883721, 0.89392578125, 0.8904296875, 0.8052277260638298, 0.7197998046875, 0.67927734375]
