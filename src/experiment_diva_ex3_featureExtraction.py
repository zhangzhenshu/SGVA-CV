...
def train(train_loader, model, optimizer, epoch):
    ...
    if epoch == 5:
        np.save("../../picture/ex3/train/origin5_zd_train.npy", [zd_list])
        np.save("../../picture/ex3/train/origin5_zy_train.npy", [zy_list])
        np.save("../../picture/ex3/train/origin5_zx_train.npy", [zx_list])
        np.save("../../picture/ex3/train/origin5_d_train.npy", [d_list])
        np.save("../../picture/ex3/train/origin5_y_train.npy", [y_list])
    ...
    if work_method == 'test':
        ...
        for seed in range(1):
            ...
            for i in range(1):
                ...
                # this test accuracy is only for logging, this is not used
                # to make any decisions during training
                test_accuracy_d, test_accuracy_y = get_accuracy_for_tsne(test_loader, model.classifier_for_tsne, args.batch_size)
                print("test accuracy y {}".format(test_accuracy_y))
